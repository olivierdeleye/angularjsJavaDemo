...
angular.module('ngdemo', ['ngRoute', 'ngTouch', 'ui.grid', 'ui.grid.selection', 'angularModalService', 'ngdemo.filters', 'ngdemo.services', 'ngdemo.directives', 'ngdemo.controllers']).
